...
if(!is_login() and !is_admin($auth_user['email'])){
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="surname" type="text" id="simpleinput" class="form-control">
                                </div>
                                ...
                                <div class="row">
                                    <div  class="col-md-4">
                                        ...
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input name="social_vk" type="text" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
                                    <div  class="col-md-4">
                                        <!-- telegram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input name="social_telegram" type="text" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
                                    <div  class="col-md-4">
                                        <!-- instagram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input name="social_instagram" type="text" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
