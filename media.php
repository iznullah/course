...
$to = 'uploaded/avatar_' . $user['email'] . '.png';
$_SESSION['user_id']=$user_id;
$is_admin= is_admin($auth_user['email']);
$has_avatar=has_avatar($user_id);
$default_image='avatar-m.png';
if (!is_admin($auth_user['email']) and $auth_user['id']!=$user_id) {
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="<?=  $has_avatar===false ? $default_image : $user['avatar']; ?>" alt="" class="img-responsive" width="200">
                                </div>
